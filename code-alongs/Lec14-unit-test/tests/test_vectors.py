...
# unittest är en modul, TestCase är en klass inom unittest.
class TestVector(unittest.TestCase):
    # setUp gives attributes that we can use later on
    # this is to avoid repeating too much
    def setUp(self): # körs automatiskt och ger oss 1,2
        self.x, self.y = 1, 2
    ...
    def test_create_empty_vector(self):
        # if we get a raised ValueErropr -> the test is OK
    ...
    # testing every element against eachother
    def test_getitem(self):
        v1 = self.create_2D_vector()
        
    
        # this approch is tedious when we have many elements in vector
    ...
    # TODO: many more tests to be performed, sub, mul etc.
